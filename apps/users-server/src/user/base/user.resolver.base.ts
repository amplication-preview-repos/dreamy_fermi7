...
export class UserResolverBase {
  ...
  async uploadProfilePhotoUrl(
    ...
    return await this.service.uploadProfilePhotoUrl(args, file);
  }
  ...
  async deleteProfilePhotoUrl(
    ...
    return await this.service.deleteProfilePhotoUrl(args);
  }
  ...
  async getDocuments(@graphql.Parent() parent: User): Promise<Document | null> {
