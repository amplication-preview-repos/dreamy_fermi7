...
export class DocumentResolverBase {
  ...
  async createDocument(
    ...
    return await this.service.createDocument({
      ...
      data: {
        ...
        memberships: args.data.memberships
          ? {
              connect: args.data.memberships,
            }
          : undefined,
      },
    });
  ...
  async getCreatedBy(@graphql.Parent() parent: Document): Promise<User | null> {
  ...
  async getMemberships(
    ...
    const result = await this.service.getMemberships(parent.id);
